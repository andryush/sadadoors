    ...
    return (
      ...
      >
        <input
          type={type}
          className={cn(
            `dark:placeholder-text-neutral-600 duration-400 group-hover/input:shadow-none flex h-10 w-full rounded-md border-none bg-gray-50 px-3 py-2 text-sm text-black  shadow-input transition 
